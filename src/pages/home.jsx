...
function Home() {
  ...
  return (
    <>
      <div className="container w-screen  flex-row items-center xl:px-28 lg:px-16 md:px-10 sm:px-5 xs:px-5 xxs:px-5 max-w-screen-2xl">
        <div className="hero space-y-5 text-center w-full m-auto lg:pt-[10%] pt-[40%]">
